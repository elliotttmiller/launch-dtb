...
.email-order-details tbody tr.order_item > td:nth-child(2) { width:52px;color:#667085;font-size:13px; }
.email-order-details tbody tr.order_item > td:last-child { width:88px;color:#101828;font-size:16px;font-weight:800; }
...
@media screen and (max-width:600px) {
	...
	.dtb-mobile-label { display:inline !important; }
	.email-order-details thead { display:none !important; }
	.email-order-details tbody tr.order_item td { display:block !important;width:auto !important;text-align:left !important; }
}
