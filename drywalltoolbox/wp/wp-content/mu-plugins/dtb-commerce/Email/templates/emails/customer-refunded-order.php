 ...
 * v10.4.0. DTB customization: copy/visual redesign, distinguishing full vs.
 * partial refunds via WooCommerce's own $partial_refund flag — no
 * independent refund-amount computation (avoids the cumulative-total bug
 * this redesign fixes). Hook sequence preserved.
 *
