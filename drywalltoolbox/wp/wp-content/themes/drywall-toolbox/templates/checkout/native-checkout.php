...
<?php wp_body_open(); ?>
	<header class="dtb-checkout__topbar">
		<a class="dtb-checkout__brand" href="<?php echo esc_url( $storefront_home_url ); ?>">
			<img src="<?php echo esc_url( home_url( '/logo-white.svg' ) ); ?>" alt="<?php esc_attr_e( 'Drywall Toolbox', 'drywall-toolbox' ); ?>" width="3000" height="917" style="display:block;height:clamp(30px,7vw,40px);width:auto;max-width:100%;">
		</a>
