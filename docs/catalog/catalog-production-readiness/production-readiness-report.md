...
Generated: `2026-08-22T10:20:57.110111+00:00`

Catalog: `products/launch/official/dtb_official_catalog.csv`  
Catalog SHA-256 (working bytes): `dcfe07891e8f40fde0074a7972c8880b9385a9bfd96cd5c9e0a0ccb37c0c374d`

Catalog SHA-256 (normalized LF): `cf213d103d6902f841c5646a8b344127a2eeb497d91ff402316f21b992ee09e8`

## Verdict

**NOT READY FOR PRODUCTION IMPORT** — 781 blocker finding rows across 754 product SKUs.
...
- Owner rows: 443
- Variation rows: 311
- Total consolidated findings: 5628
- Blocker findings: 781
...
- Baseline commit: `843491aef56adbbedf3a7510eef9f111fdc10e5f`
- Catalog-change commit: `563b05c6fbc2d1716055dfd7750a4d6516a848d3`
- Added/removed SKUs: 0/1
- Changed SKUs / field values: 754/2237
- Protected identifier changes: 6
- Field changes: {"Attribute 1 default": 2, "Attribute 1 global": 2, "Attribute 1 name": 2, "Attribute 1 value(s)": 2, "Categories": 722, "Meta: _dtb_category_key": 333, "Meta: _dtb_commerce_mode": 647, "Meta: _dtb_display_category_key": 323, "Meta: _dtb_inherit_parent_image": 2, "Meta: _dtb_parent_product_sku": 2, "Meta: _dtb_product_kind": 2, "Meta: _dtb_schematic_url": 171, "Meta: _dtb_seo_canonical": 2, "Meta: _dtb_seo_description": 2, "Meta: _dtb_seo_focus_kw": 2, "Meta: _dtb_seo_title": 2, "Meta: _dtb_variation_axis": 2, "Meta: _dtb_variation_label": 2, "Meta: _dtb_variation_sort": 2, "Meta: _dtb_variation_value": 2, "Name": 2, "Parent": 2, "Published": 1, "Short description": 1, "Slug": 2, "Type": 2, "Visibility in catalog": 1}
...
- Catalog image assignments: 1749 across 1016 unique URLs; all populated assignments still use `elliottm4.sg-host.com`.
- Production media candidates: not run valid and not run invalid by HTTP status/content type.
