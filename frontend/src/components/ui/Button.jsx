...
const VARIANTS = {
  primary: {
    ...
    color: '#ffffff',
    border: 'none',
    boxShadow: '0 4px 14px rgba(34,85,238,0.30)',
    hoverShadow: '0 8px 24px rgba(34,85,238,0.40)',
  },
  ghost: {
    ...
    boxShadow: 'none',
    hoverShadow: '0 4px 12px rgba(34,85,238,0.15)',
  },
  outline: {
    background: '#ffffff',
    color: 'var(--primary-700)',
    border: '1.5px solid rgba(34,85,238,0.30)',
    boxShadow: 'none',
    hoverShadow: '0 4px 14px rgba(34,85,238,0.12)',
  },
  danger: {
