 ...
 *
 * The destination contains no payment-method preference. Stripe's Universal
 * Payment Method remains the single provider-owned payment surface and selects
 * eligible methods inside its Payment Element.
 */
