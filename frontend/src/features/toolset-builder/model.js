...
export const TOOLSET_WORKFLOWS = Object.freeze([
  {
    ...
    capabilities: [
      ...
      { id: 'flat-boxes', label: 'Finishing Boxes', toolFamily: 'flat_box', minimum: 2, maximum: 2, description: 'Choose two finishing boxes for the complete set.' },
      { id: 'handles', label: 'Handles', toolFamily: 'handle', minimum: 3, maximum: 3, description: 'Choose three handles for the finishing and corner tools in the complete set.' },
      { id: 'angle-heads', label: 'Angle Heads', toolFamily: 'angle_head', minimum: 2, maximum: 2, description: 'Choose two angle heads for the complete set.' },
      { id: 'corner-tool', label: 'Corner Applicator', toolFamily: 'corner_box', displayCategory: 'automatic_angle_boxes_corner_applicators', minimum: 1, maximum: 1, description: 'Apply compound through the corner workflow.' },
  ...
  },
  {
    ...
    capabilities: [
      { id: 'flat-boxes', label: 'Finishing Boxes', toolFamily: 'flat_box', minimum: 2, maximum: 2, description: 'Choose two finishing boxes.' },
      { id: 'handles', label: 'Handles', toolFamily: 'handle', minimum: 3, maximum: 3, description: 'Choose three handles for the finishing and corner tools in this set.' },
      { id: 'angle-heads', label: 'Angle Heads', toolFamily: 'angle_head', minimum: 2, maximum: 2, description: 'Choose two angle heads for the finishing set.' },
      { id: 'corner-tool', label: 'Corner Applicator', toolFamily: 'corner_box', displayCategory: 'automatic_angle_boxes_corner_applicators', minimum: 1, maximum: 1, description: 'Apply compound through the corner workflow.' },
      { id: 'corner-roller', label: 'Corner Roller', toolFamily: 'corner_roller', minimum: 1, maximum: 1, description: 'Embed tape and work corner joints with a corner roller.' },
  ...
  },
  {
    ...
    capabilities: [
      ...
      { id: 'handles', label: 'Handles', toolFamily: 'handle', minimum: 2, maximum: 2, description: 'Choose two handles for the selected corner tools.' },
  ...
  },
  {
    ...
    capabilities: [
      { id: 'flat-boxes', label: 'Finishing Boxes', toolFamily: 'flat_box', minimum: 2, maximum: 2, description: 'Choose two finishing-box configurations.' },
      { id: 'handles', label: 'Handles', toolFamily: 'handle', minimum: 2, maximum: 2, description: 'Choose two handles for the selected finishing boxes.' },
