...
Assert-Contains $runtimeIntegrity 'wc-stripe-credit-card' 'Host optimization exclusions must include the replacement provider card script'
Assert-Contains $runtimeIntegrity 'wc-stripe-applepay-express-checkout' 'Host optimization exclusions must include replacement Apple Pay Express Checkout'
Assert-Contains $runtimeIntegrity 'wc-stripe-googlepay-express-checkout' 'Host optimization exclusions must include replacement Google Pay Express Checkout'
