...
Assert-Contains $runtimeIntegrity "wc-stripe-applepay-express-checkout" 'Replacement Apple Pay scripts must be protected from host optimization'
Assert-Contains $runtimeIntegrity "wc-stripe-googlepay-express-checkout" 'Replacement Google Pay scripts must be protected from host optimization'
