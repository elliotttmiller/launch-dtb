...
$checkoutCss = Read-RepositoryFile 'drywalltoolbox/wp/wp-content/themes/drywall-toolbox/assets/checkout/checkout-ux-refinements.css'
...
Assert-Contains $checkoutTemplate 'checkout-ux-refinements.css' 'Native checkout must enqueue the final payment and summary styling layer'
